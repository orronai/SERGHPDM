...
%% Constant SNR, Changing Number of Microphones, Random Angles, Without Attenuation
num_of_mics = 8 : 2 : 24;
SNR_dB = 0;
noise_gain = target_gain / 10^(SNR_dB / 20);  % Epsilon
log_nmse_E = zeros(length(num_of_mics), monte_carlo_num);
...
%% Constant SNR, Changing Number of Microphones, Random Angles, With Attenuation
num_of_mics = 8 : 2 : 24;
SNR_dB = 0;
log_nmse_E = zeros(length(num_of_mics), monte_carlo_num);
log_nmse_R = zeros(length(num_of_mics), monte_carlo_num);
...
%% Estimate ATF With Eigenvector Corresponding to The Biggest Eigenvalue, Random Angles, Without Attenuation
num_of_mics = 8 : 2 : 24;
SNR_dB = 15;
noise_gain = target_gain / 10^(SNR_dB / 20);  % Epsilon
log_mse_E = zeros(length(num_of_mics), monte_carlo_num);
...
%% Estimate ATF With Eigenvector Corresponding to The Biggest Eigenvalue, Random Angles, With Attenuation
num_of_mics = 8 : 2 : 24;
SNR_dB = 5;
log_mse_E = zeros(length(num_of_mics), monte_carlo_num);
log_mse_R = zeros(length(num_of_mics), monte_carlo_num);
